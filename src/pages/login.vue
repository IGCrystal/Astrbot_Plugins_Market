      ...
      <section class="mui-login__panel" aria-labelledby="loginTitle">
        <div class="mui-login__copy">
          ...
          <p class="mui-login__description">
            本站点仅由 <a href="https://github.com/IGCrystal" target="_blank" rel="noopener noreferrer" class="author-link">IGCrystal</a> 开发的第三方插件市场，与 AstrBot 官方无关，但是你可以前往<a href="https://plugins.astrbot.app" target="_blank" rel="noopener noreferrer" class="author-link">官方网站</a>。本网站的开发仅个人练习的目的，现已暂停公开展示。此站点仅向特定 GitHub 账户开放。请完成 GitHub 认证以继续访问。
          </p>
